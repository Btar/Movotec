...
if len(sys.argv) < 2:
   ...
   print "example:"
   print "   pFullSensors8Hz_v2.py Com12"
   print "or"
   print "   pFullSensors8Hz_v2.py /dev/rfcomm0"
else:
...
# read incoming data
   ...
   try:
      while True:
         ...
         print "0x%02x,%02x,%02x|%5d,%5d,%5d|%5d,%5d,%5d|%5d,%5d,%5d,%5d" % (data0,ts0, ts1,accel2x, accel2y, accel2z, gyrox, gyroy, gyroz, sg1,sg2,sg3,sg4)
