...
# read incoming data
   ddata = ""
   numbytes = 0
   framesize = 43 # 6byte emg, 12byte accel, 6byte gyro, 8byte strain gauge, 3 byte status+ts
   ...
   try:
      while True:
         ...
         (sg1_l,sg1_m,sg1_m2,sg1_h,sg2_l,sg2_m,sg2_m2,sg2_h,sg3_l,sg3_m,sg3_m2,sg3_h,sg4_l,sg4_m,sg4_m2,sg4_h) = struct.unpack('BBBBBBBBBBBBBBBB', data[27:43])
         sg1 = sg1_l+sg1_m*256+sg1_m2*65536+sg1_h*16777216
         sg2 = sg2_l+sg2_m*256+sg2_m2*65536+sg2_h*16777216
         sg3 = sg3_l+sg3_m*256+sg3_m2*65536+sg3_h*16777216
         sg4 = sg4_l+sg4_m*256+sg4_m2*65536+sg4_h*16777216
         ...
         print "0x%02x,%02x,%02x|%06x,%06x|%08x,%08x,%08x,%08x" % (data0,ts0, ts1,emg1, emg2, sg1,sg2,sg3,sg4)
