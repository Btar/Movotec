...
# read incoming data
   ...
   try:
      while True:
         ...
         (gyroxl, gyroxh, gyroyl, gyroyh, gyrozl, gyrozh) = struct.unpack('BBBBBB', data[13:19])
         ...
         if gyroz > 0x7FFF:
             gyroz -= 0x10000         
         print "0x%02x,%02x,%02x,%1x|%5d,%5d|%5d,%5d,%5d" % (data0,ts0, ts1, sw1, accel1x, accel2x,gyrox, gyroy, gyroz)
